...
<?php 
    $dataset=mysql_query("select * from news order by id desc");
...
?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo substr($result['content'],0, 20); ?></td>
...
?>
                                            ...
                                            <td class="center"><a href='news_edit.php?id=<?php echo $result['id'];?>'>Edit</a>&nbsp; &nbsp; <a href='news_delete.php?id=<?php echo $result['id'];?>'>Delete</a></td>
