...
$sql = "update event set title = '".$title."', description = '".$description."', `city` = '".$city."', address = '".$address."',status = '".$status."' where id = ".$id;
//echo $sql."<br/>"; 
...
<a href='event_image.php?id=<?php echo $_GET['id'];?>'>Manage images</a>
