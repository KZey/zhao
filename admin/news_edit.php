...
$sql = "update news set title = '".$title."', content = '".$content."', `type` = '".$type."', updateDate = '".$updateDate."',status = '".$status."' where id = ".$id;
//echo $sql."<br/>"; 
$result = mysql_query($sql);  
    if ( $result ) {  
          ...
          echo  $err[] = "Operation failed, please check what you input or contact system admin, <a href='news.php'>Go back</a> "; 
        } 
...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            ...
            <form class="form-horizontal" action='news_edit.php' method='post' >
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      ...
                      <select name="type" class="validate[required] form-control">
                           ...
                           <option value="1" <?php if($type == 1) {?> selected = 'true'<?php }?> >Model News</option>

                           <option value="2"  <?php if($type == 2) {?> selected = 'true'<?php }?> >PR News</option>

                           <option value="3"  <?php if($type == 3) {?> selected = 'true'<?php }?> >Event News</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        <textarea id="description" name='description' class="form-control"><?php echo $content; ?></textarea>
