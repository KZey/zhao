...
<?php 
    $dataset=mysql_query("select * from model order by id desc");
...
?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $result['name'].' '.$result['name_cn']; ?></td>

                                            <td><?php echo $result['height']; ?></td>


                                            <td>
                                                <a href='<?php echo $result['modelCard']; ?>'>Download</a>
					    </td>
...
?>
                                            ...
                                            <td class="center"><a href='model_edit.php?id=<?php echo $result['id'];?>'>Edit</a>&nbsp; &nbsp; <a href='model_delete.php?id=<?php echo $result['id'];?>'>Delete</a>&nbsp;&nbsp;&nbsp;<a href='model_image.php?id=<?php echo $result['id'];?>'>Image</a></td>
