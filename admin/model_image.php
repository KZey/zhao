...
if ((($filetype == "image/gif") || ($filetype == "image/jpeg") || ($filetype == "image/png")) && ($filesize < 20000))
{
  if ($_FILES["file"]["error"] > 0)
  ...
  else
    {
      ...
      $newfile = "./upload/mc-".$typeId.'-'.date('ymdhis').".png";
      move_uploaded_file($filepath,$newfile);
      $picture = $newfile;
      //$picture =  "./upload/".$publicRelationId.date('ymdhis').".png";


    $sql = "insert into model_image values('', ".$modelId.", ".$typeId.",'".$picture."', ".$status.") ";
    echo $sql."<br/>";
    ...
    if ( $result ) {
           ...
           $_SESSION['iflogin']= 1;
           header("Location: model_image.php?id=".$modelId);
        } else {
          echo  $err[] = "Operation failed, please check what you input or contact system admin, <a href='model_image.php?id=".$modelId.">Go back</a> ";
        }
...
<a href='model_edit.php?id=<?php echo $_GET['id']; ?>'>Back</a>
                <form class="form-horizontal" action='model_image.php' method='post' enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="col-lg-8">
                            ...
                            <select class="form-control autotab" name="typeId" tabindex="14">

                                <option value="1">protfolio</option>

                                <option value="2">polaroids</option>
...
<input name="modelId" type="hidden" value='<?php echo $_GET['id'];?>' />
...
<?php 
    $id = $_GET['id'];
    $dataset=mysql_query("select * from model_image where modelId = ".$id." order by id desc");
...
?>
                                            ...
                                            <td class="center"><a href='model_image_delete.php?id=<?php echo $result['id'];?>&model_id=<?php echo $id;?>'>Delete</a></td>
