...
<?php 
    $dataset=mysql_query("select * from public_relation order by id desc");
...
?>
                                            ...
                                            <td class="center"><a href='pr_edit.php?id=<?php echo $result['id'];?>'>Edit</a>&nbsp; &nbsp; <a href='pr_delete.php?id=<?php echo $result['id'];?>'>Delete</a>&nbsp;&nbsp;&nbsp;<a href='pr_image.php?id=<?php echo $result['id'];?>'>Image</a></td>
